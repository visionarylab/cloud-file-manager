...
context('Save and Restore from different providers from buttons',()=>{
    describe('from local storage',()=>{
        var text = "Save and restore me from buttons",
    ...
    describe('from local file',()=>{
        var text = "saving to Local File from button",
            title = "Button_Local_File_Save"
        before(()=>{
            cy.visit('/examples/all-providers.html')
        })    
        it('save a doc',()=>{
